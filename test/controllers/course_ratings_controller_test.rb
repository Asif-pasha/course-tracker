...
class CourseRatingsControllerTest < ActionController::TestCase
  ...
  test "should create course_rating" do
    assert_difference('CourseRating.count') do
      post :create, course_rating: { course_id: @course_rating.course_id, rating: @course_rating.rating, student_id: @course_rating.student_id }
    end
  ...
  test "should update course_rating" do
    patch :update, id: @course_rating, course_rating: { course_id: @course_rating.course_id, rating: @course_rating.rating, student_id: @course_rating.student_id }
    assert_redirected_to course_rating_path(assigns(:course_rating))
  end
